...
def bert_tokenize_for_valid_examples(batch_orginal_sentences, batch_noisy_sentences, bert_pretrained_name_or_path):
    ...
    if BERT_TOKENIZER is None:  # gets initialized during the first call to this method
        if bert_pretrained_name_or_path:
            BERT_TOKENIZER = AutoTokenizer.from_pretrained(bert_pretrained_name_or_path)
            print("BERT_TOKENIZER 2222222222222222", BERT_TOKENIZER)
    ...
    print("_batch_tokens",_batch_tokens)
    print("_batch_splits",_batch_splits)
