...
import neuspell
from neuspell import CnnlstmChecker, BertsclstmChecker, NestedlstmChecker, SclstmbertChecker, BertChecker, SclstmChecker, SinBertChecker
...
if SclstmChecker in all_checkers:
    ...
    print("calling from_pretrained("./data/checkpoints/scrnn-probwordnoise")")
